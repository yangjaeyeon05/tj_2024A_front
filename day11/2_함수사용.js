...
console.log( 'lib 실행' );   // 매개변수o : f12개발자 도구 출력하라 메시지 , 반환값x
// prompt('메시지:');           // 매개변수o : 알림창에 출력할 메시지 , 반환값o : 입력받은 값
// document.querySelector( )   // 매개변수o : 선택자 , 반환값o : DOM객체( html마크업을 js코드객체 )
// Math.random( );             // 매개변수x , 반환o : 0~1미만의 난수값
// 1. 함수명 ( 매개변수 ) : 매개변수x 없는 함수 호출
func1( );
//  함수명( 데이터 , 데이터 ) : 매개변수에 대입할 데이터 대입
func2( 10, 3 );
func2( 5 , 3 );
// 함수명( 데이터 ,  데이터 ) : 매개변수에 대입할 데이터 대입 , 
func3( 10, 3 ); // 10과 3을 대입해서 함수가 실행 후 13 반환하지만 변수에 대입 안했기 때문에 사라짐
